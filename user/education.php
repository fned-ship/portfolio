...
<div class="full-screen-container">
    <div class="login-container"  style='margin-top:80px;'  >
        <h1 class="login-title" id="errorMsg" >Education</h1>
        <form class="form" method="POST" >
            <div  id='job_container' style='width: 100%;' >
                ...
                <h4>school name</h4>
                <input type="text" class='req school-name' onchange="handleChange(this,1,0)" name="school_name"  required >
                </div>

                <div class="input-group" id="birthDiv" >
                <h4>school location</h4>
                <input type="text" class='req school-loc'  onchange="handleChange(this,2,0)" name="school_loc"    required >
                </div>

                <div class="input-group" id="professionDiv" >
                <h4>degree</h4>
                <input type="text" name="degree"  onchange="handleChange(this,3,0)"  class='req degree' required >
                </div>

                <div class="input-group" id="cityDiv" >
                <h4>field of study</h4>
                <input type="text" name="field" onchange="handleChange(this,4,0)"  class='req field' required >
                </div>

                <div class="input-group" id="countryDiv" >
                    <h4>start date</h4>
                    <input type="date" name="sDate"  onchange="handleChange(this,5,0)"  class='req start-date'  required >
                </div>

                <div class="input-group" id="countryDiv" >
                    <h4>end date</h4>
                    <input type="date" name="eDate"  onchange="handleChange(this,6,0)"  class='req end-date'  required >
                </div>
            ...
            <div  id='add_button' >add education</div>
...
function handleChange(input,section,skillNum){
    console.log(input.value,skillNum,section)
    switch (section){
        case 1:
            data[skillNum].schoolName=input.value ;
            break;
        case 2:
            data[skillNum].schoolLoc=input.value ;
            break;
        case 3:
            data[skillNum].degree=input.value ;
            break
        case 4:
            data[skillNum].field=input.value ;
            break
        case 5:
...
function trashClick(skillNum){
    let school_name=document.querySelectorAll(".school-name");
        let school_loc=document.querySelectorAll(".school-loc");
        ...
        school_name[skillNum].required=false;
        school_loc[skillNum].required=false;
        degree[skillNum].required=false;
        field[skillNum].required=false;
        start_date[skillNum].required=false;
        end_date[skillNum].required=false;
...
add.addEventListener('click',event=>{
    ...
    job_container.innerHTML+=`
            <div class="job_container" style='width: 100%;display: flex;justify-content: center;flex-direction:column;align-items: center;gap:40px;'  >
                <div class="input-group" id="lNameDiv" >
                <h4>school name</h4>
                <input type="text" class='req school-name' onchange="handleChange(this,1,${skillNum})" name="school_name"  required >
                </div>

                <div class="input-group" id="birthDiv" >
                <h4>school location</h4>
                <input type="text" class='req school-loc'  onchange="handleChange(this,2,${skillNum})" name="school_loc"    required >
                </div>

                <div class="input-group" id="professionDiv" >
                <h4>degree</h4>
                <input type="text" name="degree"  onchange="handleChange(this,3,${skillNum})"  class='req degree' required >
                </div>

                <div class="input-group" id="cityDiv" >
                <h4>field of study</h4>
                <input type="text" name="field" onchange="handleChange(this,4,${skillNum})"  class='req field' required >
                </div>

                <div class="input-group" id="countryDiv" >
                    <h4>start date</h4>
                    <input type="date" name="sDate"  onchange="handleChange(this,5,${skillNum})"  class='req start-date'  required >
                </div>

                <div class="input-group" id="countryDiv" >
                    <h4>end date</h4>
                    <input type="date" name="eDate"  onchange="handleChange(this,6,${skillNum})"  class='req end-date'  required >
                </div>
        ...
        for(let i=0;i<=skillNum;i++){
            try{
                school_name[i].value=data[i].schoolName;
                school_loc[i].value=data[i].schoolLoc;
                degree[i].value=data[i].degree;
                field[i].value=data[i].field;
...
if(isset($_SESSION['user'])){
    if($_SESSION['user']->role === "user"){
        ...
        $getEdu = $database->prepare("SELECT * FROM cv8  WHERE cv8_id=:cv_id ");
        $getEdu->bindParam("cv_id",$_SESSION['user']->id);
        $getEdu->execute();

        if($getEdu->rowCount()>0){
            $Edu=$getEdu->fetchObject();
            $Edu_data=json_decode($Edu->edu_data);
            ...
            data[0].schoolName="'.$Edu_data[0]->schoolName.'" ;
            data[0].schoolLoc="'.$Edu_data[0]->schoolLoc.'";
            data[0].degree="'.$Edu_data[0]->degree.'" ;
            data[0].field="'.$Edu_data[0]->field.'" ;
            data[0].startDate="'.$Edu_data[0]->startDate.'" ;
            data[0].endDate="'.$Edu_data[0]->endDate.'";

            school_name[0].value=data[0].schoolName;
            school_loc[0].value=data[0].schoolLoc;
            degree[0].value=data[0].degree;
            field[0].value=data[0].field;
            ...
            for ($i=1;$i<count($Edu_data);$i++){
                ...
                <div class='input-group' id='lNameDiv' >
                <h4>school name</h4>
                <input type='text' class='req school-name' onchange='handleChange(this,1,".$i.")' name='school_name'  required >
                </div>

                <div class='input-group' id='birthDiv' >
                <h4>school location</h4>
                <input type='text' class='req school-loc'  onchange='handleChange(this,2,".$i.")' name='school_loc'    required >
                </div>

                <div class='input-group' id='professionDiv' >
                <h4>degree</h4>
                <input type='text' name='degree'  onchange='handleChange(this,3,".$i.")'  class='req degree' required >
                </div>

                <div class='input-group' id='cityDiv' >
                <h4>field of study</h4>
                <input type='text' name='field' onchange='handleChange(this,4,".$i.")'  class='req field' required >
                </div>

                <div class='input-group' id='countryDiv' >
                    <h4>start date</h4>
                    <input type='date' name='sDate'  onchange='handleChange(this,5,".$i.")'  class='req start-date'  required >
                </div>

                <div class='input-group' id='countryDiv' >
                    <h4>end date</h4>
                    <input type='date' name='eDate'  onchange='handleChange(this,6,".$i.")'  class='req end-date'  required >
                </div>
            ...
            data[skillNum].schoolName='".$Edu_data[$i]->schoolName."' ;
            data[skillNum].schoolLoc='".$Edu_data[$i]->schoolLoc . "';
            data[skillNum].degree='".$Edu_data[$i]->degree."' ;
            data[skillNum].field='".$Edu_data[$i]->field."' ;
            data[skillNum].startDate='".$Edu_data[$i]->startDate."' ;
            data[skillNum].endDate='".$Edu_data[$i]->endDate."';

            myJSON = JSON.stringify(data);
            hidInput.value=myJSON;


                     school_name=document.querySelectorAll('.school-name');
                     school_loc=document.querySelectorAll('.school-loc');
        ...
        if(isset($_POST['send'])){
            ...
            if($getEdu->rowCount()==0){
                $send = $database->prepare("INSERT INTO cv8 (edu_data,cv8_id) VALUES(:edu_data,:cv8_id)");
                $send->bindParam("edu_data",$_POST['data']);
                $send->bindParam("cv8_id",$_SESSION['user']->id);
                $send->execute();
            }else{
                $send = $database->prepare("UPDATE cv8 SET edu_data=:edu_data WHERE cv8_id=:cv8_id");
                $send->bindParam("edu_data",$_POST['data']);
                $send->bindParam("cv8_id",$_SESSION['user']->id);
                $send->execute();
            }
            //header('Location: cv8.php' , true);
            echo "<script> location.replace('work.php') </script>";
        }
    }else{
        header("location:".$webURL."login.php",true); 
    }
}else{
    header("location:".$webURL."login.php",true); 
}

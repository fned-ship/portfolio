...
<div id="nav-phone" >
    ...
    <svg fill="hsl(var(--primary-hsl))" class="svg-icon" width="30px" height="30px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
...
<div class="full-screen-container">
   <div class="login-container" style="position:relative; margin-top:80px; " >
      <form class="form" method="POST"  >
            <h2 style="text-align:center ; margin:0; color:hsl(var(--primary-light-hsl), 1);" >chose the color you prefer</h2>
            <div class="color-div" >
                <div class="color" ></div>
                <div class="color"></div>
                <div class="color"></div>
            ...
            <p id='error' style='color:red;text-align:center;display:none;' >you have to chose a color !</p>

            <h2 style="text-align:center ; margin:10px 0 0 0; color:hsl(var(--primary-light-hsl), 1);" >chose the font color you prefer</h2>
            <div class="color-div" >
            ...
            <p id='error1' style='color:red;text-align:center;display:none;' >you have to chose a color !</p>

            <input type='hidden' name='data' id="hiddenInput" >
        <button type="submit"  name="submit" class="send-button">submit</button>
      </form>
   </div>
</div>
...
<script>
    ...
    var data={
        ...
        secondaryColorOpacity1:"",
        primaryColor:""
    } 

    var fontColors=["#cdd3d6","#e3dac9","#f0ead6","#f8f8ff","#FFF","#FCFFF9","#FAF9F6","#F8F9F5","#F9F6EE","#F8F8E8","#F4F0EC","#F3F0E8","#FFF8E7","#FDF5E6","#E9E9E4","#F5F5DC","#FAF0E6","#F0EDDB","#E8EAE6","#FFFFF0","#FFFFE0","#FBF5DF","#FFF8DC","#FFFDD0","#F5FFFA","#827676"];
    let fontColorsDiv=document.querySelectorAll(".font-color");
    for(let i=0;i<fontColorsDiv.length;i++){
        fontColorsDiv[i].style.backgroundColor=fontColors[i];
        fontColorsDiv[i].addEventListener('click',()=>{
        console.log(fontColors[i]);
        for(let j=0;j<fontColorsDiv.length;j++){
            fontColorsDiv[j].innerHTML="";
        }
        fontColorsDiv[i].innerHTML=`<svg fill="#000000" style='margin:2px 0 0 3px;' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  width="26px" height="26px" viewBox="0 0 394.893 394.893" xml:space="preserve">
            <g>
                <g>
        ...
        data.primaryColor=fontColors[i];
    ...
    var colors=["#ffe5b4","#ffa6c9","#ff8c69","#efbbcc","#f0f8ff","#f3e5ab","#f4c430","#fc8aaa","#ffef00", "#f0dc82","#e4d00a","#ab274f","#960018","#800000","#65000b","#568203","#50c87c","#4a0100","#317873","#ff80ed","#065535","#133337","#ffc0cb","#ffe4e1","#008080","#ff0000","#ffd700","#00ffff","#ffa500","#ff7373","#0000ff","#40e0d0","#b0e0e6","#d3ffce","#666666","#bada55","#faebd7","#fa8072","#003366","#ffb6c1","#c0c0c0","#ffff00","#800000","#800080","#c39797","#7fffd4","#00ff00","#fff68f","#f08080","#20b2aa","#ffc3a0","#66cdaa","#c0d6e4","#ff6666","#ff00ff","#ffdab9","#cbbeb5","#ff7f50","#468499","#afeeee","#008000","#b4eeb4","#00ced1","#f6546a","#660066","#0e2f44","#b6fcd5","#daa520","#990000","#6897bb","#000080","#f5f5dc","#088da5","#8b0000","#8a2be2","#ffff66","#ccff00","#81d8d0","#2acaea","#0a75ad","#ff4040","#66cccc","#420420","#a0db8e","#ff1493","#999999","#cc0000","#3399ff","#794044","#00ff7f","#3498db"];
   let colorsDiv=document.querySelectorAll(".color");
   for(let i=0;i<colorsDiv.length;i++){
    colorsDiv[i].style.backgroundColor=colors[i];
    colorsDiv[i].addEventListener('click',()=>{
        console.log(colors[i]);
        for(let j=0;j<colorsDiv.length;j++){
            colorsDiv[j].innerHTML="";
        }
        colorsDiv[i].innerHTML=`<svg fill="#000000" style='margin:2px 0 0 3px;' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  width="26px" height="26px" viewBox="0 0 394.893 394.893" xml:space="preserve">
            <g>
                <g>
                    <path d="M344.426,191.963c-6.904,0-12.5,5.597-12.5,12.5V350.91H25V43.982h246.57c6.904,0,12.5-5.597,12.5-12.5
                        c0-6.903-5.596-12.5-12.5-12.5H12.5c-6.903,0-12.5,5.597-12.5,12.5V363.41c0,6.903,5.597,12.5,12.5,12.5h331.926
        ...
        data.secondaryColor=colors[i];
        data.secondaryColorOpacity=hexToRGBA(colors[i],0.7);
        data.secondaryColorOpacity1=hexToRGBA(colors[i],0.3);
        myJSON = JSON.stringify(data);
        hidInput.value=myJSON;
...
if(isset($_SESSION['user'])){
    if($_SESSION['user']->role === "user"){
        $getColor = $database->prepare("SELECT *  FROM  color WHERE user_id=:c_id");
        $getColor->bindParam("c_id",$_SESSION['user']->id);
        $getColor->execute();

        if($getColor->rowCount()>0){
            $color=$getColor->fetchObject()->color;
            $color_data=json_decode($color);
            echo '<script>
            let indexOfColor=colors.indexOf("'.$color_data->secondaryColor.'");
            let indexOfFontColor=fontColors.indexOf("'.$color_data->primaryColor.'");

            colorsDiv[indexOfColor].innerHTML=`<svg fill="#000000" style="margin:2px 0 0 3px;" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  width="26px" height="26px" viewBox="0 0 394.893 394.893" xml:space="preserve">
                    <g>
                        <g>
                            <path d="M344.426,191.963c-6.904,0-12.5,5.597-12.5,12.5V350.91H25V43.982h246.57c6.904,0,12.5-5.597,12.5-12.5
                                c0-6.903-5.596-12.5-12.5-12.5H12.5c-6.903,0-12.5,5.597-12.5,12.5V363.41c0,6.903,5.597,12.5,12.5,12.5h331.926
                ...
                fontColorsDiv[indexOfFontColor].innerHTML=`<svg fill="#000000" style="margin:2px 0 0 3px;" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  width="26px" height="26px" viewBox="0 0 394.893 394.893" xml:space="preserve">
                    <g>
                        <g>
                            <path d="M344.426,191.963c-6.904,0-12.5,5.597-12.5,12.5V350.91H25V43.982h246.57c6.904,0,12.5-5.597,12.5-12.5
                                c0-6.903-5.596-12.5-12.5-12.5H12.5c-6.903,0-12.5,5.597-12.5,12.5V363.41c0,6.903,5.597,12.5,12.5,12.5h331.926
                ...
                data.primaryColor=fontColors[indexOfFontColor];
                data.secondaryColor=colors[indexOfColor];
                data.secondaryColorOpacity=hexToRGBA(colors[indexOfColor],0.7);
                data.secondaryColorOpacity1=hexToRGBA(colors[indexOfColor],0.3);
                myJSON = JSON.stringify(data);
                hidInput.value=myJSON;
            </script>';
        }
        ...
        if(isset($_POST['submit'])){
            ...
            if($data->secondaryColor==""){
                ...
                if($getColor->rowCount()==0){
                    $send = $database->prepare("INSERT INTO color (color,user_id) VALUES (:color,:c_id)");
                    $send->bindParam("color",$_POST["data"]);
                    $send->bindParam("c_id",$_SESSION['user']->id);
                    $send->execute();
                }
                else{
                    $send = $database->prepare("UPDATE color SET color=:color WHERE user_id=:c_id ");
                    $send->bindParam("color",$_POST["data"]);
                    $send->bindParam("c_id",$_SESSION['user']->id);
                    $send->execute();
                }
                echo "<script> location.replace('getPortf.php') </script>";
            }
